...
// Each of these fields can contain the actual section of the model card or
// a link to a html/markdown file to be read and processed before being displayed
// to the user.
message ModelCard {
  // The id of the model this ModelCard is tied to.
  string model_id = 1;

  // A short, general-purpose description of the model and what it's used for
  string summary = 2;

  // A more elaborate description that points out architecture, input/output formats, etc.
  string description = 3;

  // Describes what use cases where in mind when the model was created.
  string intended_use = 4;

  // How to use the model in production or for development
  string usage_notes = 5;

  // Know issues, i.e., susceptible to occlusion, issues with non-latin char. sets, etc.
  string limitations = 6;

  // Qualitative and/or uantitative description of the data used to train the model.
  string training_data = 7;

  // The origin of the data used for training the model.
  string data_source = 8;

  // Known biases in the data and/or model architecture.
  string known_biases = 9;

  // Relevant evaluation results
  string evaluations = 10;

  // Internal documentation for the referenced model
  string internal_doc = 11;

  // Owner or creator of the model.
  oneof created_by {
    string user_id = 12; // the id of the user who owns the original model.
    string publisher = 13; // An external entity that published the model.
  }
}
...
////////////////////////////////////////////////////////////////////////////////
// Messages from /proto/clarifai/api/password_policies.proto
////////////////////////////////////////////////////////////////////////////////
...
message OperatorType {
  ...
  // Title for this operator
  string title = 2;

  // Description for this operator
  string description = 3;

  // The list of input fields that this operator accepts.
  repeated string input_fields = 4;

  // The list of output fields that this model accepts.
  repeated string output_fields = 5;

  // The configurable fields used for this operator type.
  // Each field has a path into the Operator object such as "data.concepts" or "config.margin".
  repeated ModelTypeField configurable_fields = 6;

  // Is this operator type is available only to internal users.
  bool internal_only = 7;

  // Can this operator be evaluated?
  bool evaluable = 8;
}
...
////////////////////////////////////////////////////////////////////////////////
// Messages originally from /proto/clarifai/sdk_billing/sdk_billing.proto
////////////////////////////////////////////////////////////////////////////////
/*
...
////////////////////////////////////////////////////////////////////////////////
// Messages originally from /proto/clarifai/analytics/analytics.proto
////////////////////////////////////////////////////////////////////////////////
message DeviceInfo {
