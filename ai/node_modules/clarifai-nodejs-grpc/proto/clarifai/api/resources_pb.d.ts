...
export class ModelCard extends jspb.Message { 
    getModelId(): string;
    setModelId(value: string): ModelCard;

    getSummary(): string;
    setSummary(value: string): ModelCard;

    getDescription(): string;
    setDescription(value: string): ModelCard;

    getIntendedUse(): string;
    setIntendedUse(value: string): ModelCard;

    getUsageNotes(): string;
    setUsageNotes(value: string): ModelCard;

    getLimitations(): string;
    setLimitations(value: string): ModelCard;

    getTrainingData(): string;
    setTrainingData(value: string): ModelCard;

    getDataSource(): string;
    setDataSource(value: string): ModelCard;

    getKnownBiases(): string;
    setKnownBiases(value: string): ModelCard;

    getEvaluations(): string;
    setEvaluations(value: string): ModelCard;

    getInternalDoc(): string;
    setInternalDoc(value: string): ModelCard;


    hasUserId(): boolean;
    clearUserId(): void;
    getUserId(): string;
    setUserId(value: string): ModelCard;


    hasPublisher(): boolean;
    clearPublisher(): void;
    getPublisher(): string;
    setPublisher(value: string): ModelCard;


    getCreatedByCase(): ModelCard.CreatedByCase;
...
export class DimensionList extends jspb.Message { 
    ...
    clearDimensionMap(): void;

    clearIntValueListList(): void;
    getIntValueListList(): Array<number>;
    setIntValueListList(value: Array<number>): DimensionList;
    addIntValueList(value: number, index?: number): number;
...
export class UserInfo extends jspb.Message { 
    ...
    hasIsOrgAdmin(): boolean;
    clearIsOrgAdmin(): void;
    getIsOrgAdmin(): boolean;
    setIsOrgAdmin(value: boolean): UserInfo;
    ...
    getNullableIsOrgAdminCase(): UserInfo.NullableIsOrgAdminCase;
...
export namespace UserInfo {
    ...
    export enum NullableIsOrgAdminCase {
        NULLABLE_IS_ORG_ADMIN_NOT_SET = 0,
...
export class OperatorType extends jspb.Message { 
    getId(): string;
    setId(value: string): OperatorType;

    getTitle(): string;
    setTitle(value: string): OperatorType;

    getDescription(): string;
    setDescription(value: string): OperatorType;

    clearInputFieldsList(): void;
    getInputFieldsList(): Array<string>;
    setInputFieldsList(value: Array<string>): OperatorType;
    addInputFields(value: string, index?: number): string;

    clearOutputFieldsList(): void;
    getOutputFieldsList(): Array<string>;
    setOutputFieldsList(value: Array<string>): OperatorType;
    addOutputFields(value: string, index?: number): string;

    clearConfigurableFieldsList(): void;
    getConfigurableFieldsList(): Array<ModelTypeField>;
    setConfigurableFieldsList(value: Array<ModelTypeField>): OperatorType;
    addConfigurableFields(value?: ModelTypeField, index?: number): ModelTypeField;

    getInternalOnly(): boolean;
    setInternalOnly(value: boolean): OperatorType;

    getEvaluable(): boolean;
    setEvaluable(value: boolean): OperatorType;


    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): OperatorType.AsObject;
    static toObject(includeInstance: boolean, msg: OperatorType): OperatorType.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: OperatorType, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): OperatorType;
    static deserializeBinaryFromReader(message: OperatorType, reader: jspb.BinaryReader): OperatorType;
}
...
export namespace OperatorType {
    export type AsObject = {
        ...
        inputFieldsList: Array<string>,
        outputFieldsList: Array<string>,
        configurableFieldsList: Array<ModelTypeField.AsObject>,
        internalOnly: boolean,
        evaluable: boolean,
    }
}
...
export class FindDuplicateAnnotationsJob extends jspb.Message { 
    ...
    clearPcaProjectionComparator(): void;
...
export class DuplicateAnnotations extends jspb.Message { 

    hasRepresentative(): boolean;
    clearRepresentative(): void;
    getRepresentative(): Annotation | undefined;
    setRepresentative(value?: Annotation): DuplicateAnnotations;

    clearDuplicatesList(): void;
    getDuplicatesList(): Array<Annotation>;
    setDuplicatesList(value: Array<Annotation>): DuplicateAnnotations;
    addDuplicates(value?: Annotation, index?: number): Annotation;


    serializeBinary(): Uint8Array;
    toObject(includeInstance?: boolean): DuplicateAnnotations.AsObject;
    static toObject(includeInstance: boolean, msg: DuplicateAnnotations): DuplicateAnnotations.AsObject;
    static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
    static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
    static serializeBinaryToWriter(message: DuplicateAnnotations, writer: jspb.BinaryWriter): void;
    static deserializeBinary(bytes: Uint8Array): DuplicateAnnotations;
    static deserializeBinaryFromReader(message: DuplicateAnnotations, reader: jspb.BinaryReader): DuplicateAnnotations;
}

export namespace DuplicateAnnotations {
    export type AsObject = {
        representative?: Annotation.AsObject,
        duplicatesList: Array<Annotation.AsObject>,
    }
}

export class DuplicateAnnotationsResults extends jspb.Message { 
    clearResultsList(): void;
    getResultsList(): Array<DuplicateAnnotations>;
    setResultsList(value: Array<DuplicateAnnotations>): DuplicateAnnotationsResults;
    addResults(value?: DuplicateAnnotations, index?: number): DuplicateAnnotations;
...
export namespace DuplicateAnnotationsResults {
    export type AsObject = {
        resultsList: Array<DuplicateAnnotations.AsObject>,
    }
}
