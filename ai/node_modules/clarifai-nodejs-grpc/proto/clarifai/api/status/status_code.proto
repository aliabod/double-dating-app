...
enum StatusCode {
  reserved 33000, 33001, 33002, 33100, 33101, 33102, 33103, 33104, 33105, 33106, 33200, 33201, 33203, 33210, 39995, 40018, 40019; // deprecated status codes that should not be reused
  ...
  CONN_TOKEN_INVALID = 11001 [deprecated = true];
  ...
  CONN_AUTH_METHOD_DISABLED = 11200; // authentication method is disabled
  ...
  MODEL_TRAINING_INSUFFICIENT_DATA = 21117; // Training got error due to insufficient labelled data
  MODEL_TRAINING_INVALID_PARAMS = 21118;
  MODEL_TRAINING_INVALID_DATA_TOLERANCE_EXCEEDED = 21119; // Training is stopped because too much data was dropped
  ...
  MODEL_NOT_DEPLOYED = 21353; // Used when model spire deployment is manually taken down or due to inactivity
  ...
  INPUT_DOWNLOAD_PENDING = 30001; // when things are async, this is the default status.
  INPUT_DOWNLOAD_FAILED = 30002; // any type of error downloading and processing
